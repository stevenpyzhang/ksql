...
public class ParamTypesTest {
  ...
  public void shouldPassCompatibleSchemasWithImplicitCasting() {
    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.INTEGER, null), ParamTypes.LONG, true), is(true));
    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.INTEGER, null), ParamTypes.DOUBLE, true), is(true));
    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.INTEGER, null), ParamTypes.DECIMAL, true), is(true));

    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.BIGINT, null), ParamTypes.DOUBLE, true), is(true));
    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.BIGINT, null), ParamTypes.DECIMAL, true), is(true));

    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.decimal(2, 1), null), ParamTypes.DOUBLE, true), is(true));
  }

  @Test
  public void shouldNotPassInCompatibleSchemasWithImplicitCasting() {
    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.BIGINT, null), ParamTypes.INTEGER, true), is(false));

    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.DOUBLE, null), ParamTypes.LONG, true), is(false));

    assertThat(ParamTypes.areCompatible(SqlArgument.of(SqlTypes.DOUBLE, null), ParamTypes.DECIMAL, true), is(false));
  }
}
