...
public class UdfIndexTest {
  ...
  public void shouldFindOneArg() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null)));
  ...
  public void shouldFindOneArgWithCast() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.INTEGER, null)));
  ...
  public void shouldFindTwoDifferentArgs() {
    ...
    final KsqlScalarFunction fun = udfIndex
        .getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null), SqlArgument.of(SqlTypes.INTEGER, null)));
  ...
  public void shouldFindTwoSameArgs() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex
        .getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null), SqlArgument.of(SqlTypes.STRING, null)));
  ...
  public void shouldFindTwoArgSameFirstConflict() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null), SqlArgument.of(SqlTypes.STRING, null)));
  ...
  public void shouldChooseCorrectStruct() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(STRUCT1_ARG, null)));
  ...
  public void shouldChooseCorrectMap() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(MAP1_ARG, null)));
  ...
  public void shouldAllowAnyDecimal() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(DECIMAL1_ARG, null)));
  ...
  public void shouldFindVarargWithStruct() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(STRUCT1_ARG, null), SqlArgument.of(STRUCT1_ARG, null)));
  ...
  public void shouldFindVarargWithList() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex
        .getFunction(ImmutableList.of(SqlArgument.of(SqlArray.of(SqlTypes.STRING), null)));
  ...
  public void shouldFindVarargWithNullValues() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(Arrays.asList(null));
  ...
  public void shouldFindVarargWithSomeNullValues() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(Arrays.asList(null, SqlArgument.of(SqlTypes.STRING, null), null));
  ...
  public void shouldChooseNonVarargWithNullValuesOfPartialNulls() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(Arrays.asList(SqlArgument.of(SqlTypes.STRING, null), null));
  ...
  public void shouldChooseCorrectlyInComplicatedTopology() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(Arrays.asList(SqlArgument.of(SqlTypes.STRING, null), SqlArgument.of(INTEGER, null), null, SqlArgument.of(INTEGER, null)));
  ...
  public void shouldFindGenericMethodWithIntParam() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(Collections.singletonList(SqlArgument.of(SqlArray.of(SqlTypes.INTEGER), null)));
  ...
  public void shouldFindGenericMethodWithStringParam() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(Collections.singletonList(SqlArgument.of(SqlArray.of(SqlTypes.STRING), null)));
  ...
  public void shouldMatchGenericMethodWithMultipleIdenticalGenerics() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(INTEGER, null), SqlArgument.of(INTEGER, null)));
  ...
  public void shouldMatchGenericMethodWithMultipleGenerics() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(INTEGER, null), SqlArgument.of(SqlTypes.STRING, null)));
  ...
  public void shouldMatchNestedGenericMethodWithMultipleGenerics() {
    ...
    // When:
    final KsqlScalarFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(SqlArray.of(SqlTypes.INTEGER), null), SqlArgument.of(SqlArray.of(SqlTypes.INTEGER), null)));
  ...
  public void shouldNotMatchIfParamLengthDiffers() {
    ...
    final Exception e = assertThrows(
        KsqlException.class,
        () -> udfIndex.getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null), SqlArgument.of(SqlTypes.STRING, null)))
    );
  ...
  public void shouldNotMatchIfNoneFound() {
    ...
    final Exception e = assertThrows(
        KsqlException.class,
        () -> udfIndex.getFunction(ImmutableList.of(SqlArgument.of(INTEGER, null)))
    );
  ...
  public void shouldNotMatchIfNoneFoundWithNull() {
    ...
    final Exception e = assertThrows(
        KsqlException.class,
        () -> udfIndex.getFunction(Arrays.asList(SqlArgument.of(INTEGER, null), null))
    );
  ...
  public void shouldNotChooseSpecificWhenTrickyVarArgLoop() {
    ...
    final Exception e = assertThrows(
        KsqlException.class,
        () -> udfIndex.getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null), SqlArgument.of(INTEGER, null), SqlArgument.of(SqlTypes.STRING, null)))
    );
  ...
  public void shouldNotMatchWhenNullTypeInArgsIfParamLengthDiffers() {
    ...
    final Exception e = assertThrows(
        KsqlException.class,
        () -> udfIndex.getFunction(Arrays.asList(SqlArgument.of(SqlTypes.STRING, null), null))
    );
  ...
  public void shouldNotMatchVarargDifferentStructs() {
    ...
    final Exception e = assertThrows(
        KsqlException.class,
        () -> udfIndex.getFunction(ImmutableList.of(SqlArgument.of(STRUCT1_ARG, null), SqlArgument.of(STRUCT2_ARG, null)))
    );
  ...
  public void shouldNotMatchGenericMethodWithAlreadyReservedTypes() {
    ...
    final Exception e = assertThrows(
        KsqlException.class,
        () -> udfIndex.getFunction(ImmutableList.of(SqlArgument.of(INTEGER, null), SqlArgument.of(SqlTypes.STRING, null)))
    );
  ...
  public void shouldNotMatchNestedGenericMethodWithAlreadyReservedTypes() {
    ...
    final Exception e = assertThrows(
        KsqlException.class,
        () -> udfIndex
            .getFunction(ImmutableList.of(SqlArgument.of(SqlArray.of(SqlTypes.INTEGER), null), SqlArgument.of(SqlArray.of(SqlTypes.STRING), null)))
    );
  ...
  public void shouldSupportMatchAndImplicitCastEnabled() {
    ...
    // When:
    final KsqlFunction fun = udfIndex.getFunction(ImmutableList.of(SqlArgument.of(INTEGER, null)));
