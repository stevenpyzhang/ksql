...
public class ExpressionTypeManagerTest {
  ...
  public void shouldEvaluateTypeForUDF() {
    ...
    verify(udfFactory).getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.DOUBLE, null)));
    verify(function).getReturnType(ImmutableList.of(SqlArgument.of(SqlTypes.DOUBLE, null)));
  }
  ...
  public void shouldEvaluateTypeForStringUDF() {
    ...
    verify(udfFactory).getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null)));
    verify(function).getReturnType(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null)));
  }
