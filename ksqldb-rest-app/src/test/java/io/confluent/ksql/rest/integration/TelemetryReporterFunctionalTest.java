...
public class TelemetryReporterFunctionalTest {
  ...
  private static final TestKsqlRestApp REST_APP = TestKsqlRestApp
      ...
      .withProperty("ksql.metric.reporters", "io.confluent.telemetry.reporter.TelemetryReporter")
      .withProperty("confluent.telemetry.exporter._local.enabled", true)
      .withProperty("confluent.telemetry.exporter._local.type", "kafka")
      .withProperty("confluent.telemetry.exporter._local.topic.replicas", "1")
  ...
  public void shouldReadTelemetryMetrics() throws InterruptedException {
    ...
    while (System.currentTimeMillis() - startMs < 20000 && (!ksqlMetricsPresent)) {
