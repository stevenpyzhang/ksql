...
public class UdafAggregateFunctionFactoryTest {
  ...
  public void shouldAppendInitParamTypesWhenLookingUpFunction() {
    ...
    functionFactory.createAggregateFunction(
        ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null)),
        new AggregateFunctionInitArguments(0, ImmutableMap.of(), ImmutableList.of(1))
    );

    // Then:
    verify(functionIndex).getFunction(ImmutableList.of(SqlArgument.of(SqlTypes.STRING, null), (SqlArgument.of(SqlTypes.INTEGER, null))));
  }
  ...
  public void shouldHandleNullLiteralParams() {
    ...
    // Then:
    verify(functionIndex).getFunction(Arrays.asList(SqlArgument.of(SqlTypes.STRING, null), null, SqlArgument.of(SqlTypes.BIGINT, null)));
  }
