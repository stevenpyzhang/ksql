...
public class ServerState {
  ...
  private static final class StateWithReason {
    ...
    private StateWithReason(final State state, KsqlErrorMessage error) {
      this.state = state;
   ...
   * is still in the INITIALIZING state and an error code. This reason string and corresponding error code will be
   * used to add context to the API error indicating that the server is not yet ready to serve requests.
   *
